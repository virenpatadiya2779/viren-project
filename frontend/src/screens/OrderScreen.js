                  ...
                  <MDBCardBody>
                    ...
                    <MDBContainer>
                      <MDBCol md='12' className='text-center'>
                        ...
                        <img
                          src='/images/logo.png'
                          alt='VirenCart Ecommerce'
                          height='40'
                        />
                        <p className='pt-0'>VirenCart Ecommerce</p>
                      </MDBCol>
                    </MDBContainer>
                    <MDBRow>
                      <MDBCol xl='8'>
                          ...
                          {order.isPaid && (
                            <li className='text-muted'>
                              <MDBIcon
                                ...
                                style={{ color: '#84B0CA' }}
                              />
                              <span className='fw-bold ms-1'>Payment Id: </span>
                      ...
                      <MDBCol xl='3'>
                        <MDBTypography listUnStyled>
                          ...
                          <li className='text-muted ms-2 mt-2'>
                            <span class='text-black me-3'>Subtotal</span>₹
                            {order.itemsPrice}
                          </li>
                          <li className='text-muted ms-2 mt-2'>
                            <span class='text-black me-3'>Tax(15%)</span>₹
                            {order.taxPrice}
                          </li>
                          <li className='text-muted ms-2 mt-2'>
                            <span class='text-black me-3'>Shipping</span>₹
                            {order.shippingPrice}
                          </li>
                        </MDBTypography>
